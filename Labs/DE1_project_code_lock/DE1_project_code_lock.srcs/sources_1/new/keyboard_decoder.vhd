...
begin
    ...
    begin
        ...
        case s_btn_in is
            ...
            when "000000000010" => decoder_out <= "1011"; -- Button 0 pressed
            when "000000000001" => decoder_out <= "1100"; -- Button # pressed
            when "000000000000" => decoder_out <= "0000"; -- Less than one button pressed
            when others         => decoder_out <= "0000"; -- More than one button pressed
        end case;
